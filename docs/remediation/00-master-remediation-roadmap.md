...
|---|---|---|---|---|
| F0 — reproducible baseline | [02 Build, Packaging, and Host Validation](02-build-packaging-host-validation.md) | In progress — Agent 02; branch published; initial hosted triggers hit a GitHub Actions outage; BLD-007 and BLD-011 externally blocked | Approved planning baseline | Complete the checked-in eight-job hosted CI matrix after Actions recovery; obtain reviewed identity/distribution/licensing decisions, AU registration, VST3 SDK validator, and required commercial-host access. |
