...
Use only `not-started`, `in-progress`, `blocked`, `fail`, or `pass`. A requirement may be `pass` only when its acceptance criterion and verification evidence are linked. Agent 03 owns these entries under the current handoff.

| Requirement | Status | Evidence | Notes |
|---|---|---|---|
| BLD-001 | in-progress | [Build foundation](evidence/workstream-02/build-foundation.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Hosted CI attempt](evidence/workstream-02/hosted-ci-execution.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Exact-commit run `29714998121` reached all eight supported rows, exposed real project defects, and produced retained logs/uploads; their root-cause fixes are locally green, but one all-green corrective hosted run remains. |
| BLD-002 | in-progress | [Build foundation](evidence/workstream-02/build-foundation.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Supported CMake remains independent of Projucer, generated amalgamations, `JUCE_DIR`, and the machine path; JUCE configuration now propagates to consumer-compiled modules, pending the corrective cross-platform run. |
| BLD-003 | in-progress | [Dependency/license review](evidence/workstream-02/dependency-license-review.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Hosted configure evidence resolved the pinned revision on all rows; the owner's distribution-licence decision and a green corrective run remain. |
...
| BLD-005 | in-progress | [Wrapper and bus contract](evidence/workstream-02/wrapper-bus-contract.md) · [Validation](evidence/workstream-02/validation-evidence.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Fresh local actual-wrapper/pluginval remains green and both hosted Intel macOS rows passed the complete gate; the corrective full matrix remains. |
| BLD-006 | in-progress | [Wrapper and bus contract](evidence/workstream-02/wrapper-bus-contract.md) · [Validation](evidence/workstream-02/validation-evidence.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Local metadata, bus, actual-wrapper, and pluginval evidence remains green and both Intel hosted rows passed; AU/commercial category evidence and the corrective full matrix remain. |
...
| BLD-008 | in-progress | [Warning baseline](evidence/workstream-02/warning-baseline.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Recovery logs exposed and the source now fixes MSVC/GCC project warnings; fresh local strict builds are green and the corrective supported-CI reports remain. |
| BLD-009 | in-progress | [Standalone lifecycle](evidence/workstream-02/standalone-lifecycle.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Both hosted Intel macOS rows passed; hosted arm64 exposed a startup parameter/UI race now covered by a regression and stable forced local repeats; corrective hosted proof remains. |
| BLD-010 | in-progress | [CTest and CI enforcement](evidence/workstream-02/ctest-ci-enforcement.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Hosted CI attempt](evidence/workstream-02/hosted-ci-execution.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Run `29714998121` proved all eight rows and correct sentinel skipping reach project commands; fixes are locally 9/9 with every label, and an all-green corrective run remains. |
| BLD-011 | blocked | [Validator and linked-manifest evidence](evidence/workstream-02/validation-evidence.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Hosted CI attempt](evidence/workstream-02/hosted-ci-execution.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Local actual-wrapper/pluginval and both Intel hosted validator rows pass; AU registration outside ephemeral CI, the VST3 SDK validator, commercial hosts, and a green corrective full matrix remain unavailable. |
| BLD-012 | in-progress | [Artifact staging and build manifest](evidence/workstream-02/artifact-staging-manifest.md) · [Linked validation evidence](evidence/workstream-02/validation-evidence.md) · [Agent 02 continuation](evidence/workstream-02/continuation-preflight.md) · [Agent 03 recovery](evidence/workstream-02/agent-03-hosted-ci-recovery.md) | Fresh Debug/Release linked manifests deep-verify and both Intel hosted rows uploaded verified evidence; release remains blocked by BLD-007, BLD-011, and the corrective full matrix. |
...
- Agent 02's [continuation preflight](evidence/workstream-02/continuation-preflight.md) reconfirmed fresh local Debug/Release 9/9 CTest and linked validation and passed static workflow audit. The later [hosted CI report](evidence/workstream-02/hosted-ci-execution.md) records authorized publication and six jobless outage triggers. Agent 03's [recovery report](evidence/workstream-02/agent-03-hosted-ci-recovery.md) adds a fresh local baseline, direct official-status polling through recovery, complete exact-commit run `29714998121`, retained logs/uploads, and root-cause fixes for every project failure. No hosted-dependent status is promoted until the corrective full matrix is all green.
