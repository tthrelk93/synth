...
foreach(_repeat RANGE 1 ${SYNTH_REPEAT_COUNT})
    ...
    if(_virtual_display_provider STREQUAL "inherited-x11")
        list(FIND _command -- _environment_separator_index)
        if(_environment_separator_index LESS 0)
            message(FATAL_ERROR "pluginval environment command is missing its option separator")
        endif()
        list(INSERT _command ${_environment_separator_index} "DISPLAY=${_inherited_display}")
        list(APPEND _recorded_command "DISPLAY=<INHERITED_X11_DISPLAY>")
    endif()
    list(APPEND _recorded_command --)
    if(_virtual_display_provider STREQUAL "xvfb-run")
...
_synth_json_set_string(_report virtual_display_provider "${_virtual_display_provider}")
