...
string(JSON _renderer_warmup_provider GET "${_aggregate}" environment renderer_warmup_provider)
...
if(NOT _renderer_warmup_provider STREQUAL "fresh-process")
    message(FATAL_ERROR "standalone lifecycle has an invalid renderer-warmup provider")
endif()
